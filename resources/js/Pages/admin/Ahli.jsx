...
export default function ArticlesManagementPage() {
    ...
    const { ahlis, flash } = usePage().props;
    ...
    const filteredAhlis = ahlis.filter((ahli) =>
    ...
    const confirmDelete = () => {
        ...
        router.delete(`/admin/ahli/${ahliId}`, {
            onSuccess: () => {
                    ...
                    <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                        ...
                        >
                            ...
                            >
                                <Button asChild>
                                    <Link
                                        href={route("create-ahli-dashboard")}
                                    >
